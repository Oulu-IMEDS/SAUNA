...
class DACblock_with_inception(nn.Module):
    ...
    def forward(self, x):
        ...
        dilate_concat = nonlinearity(self.conv1x1(
            torch.cat([dilate1_out, dilate2_out], 1)))
...
class DACblock_with_inception_blocks(nn.Module):
    def __init__(self, channel):
        ...
        self.conv5x5 = nn.Conv2d(
            channel, channel, kernel_size=5, dilation=1, padding=2)
