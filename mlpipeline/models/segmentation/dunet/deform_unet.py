from mlpipeline.models.segmentation.dunet.deform_part import deform_up, deform_down, deform_inconv
from mlpipeline.models.segmentation.dunet.unet_parts import *
...
def check():
    model = DUNetV1V2(n_channels=3, n_classes=1, downsize_nb_filters_factor=4)
